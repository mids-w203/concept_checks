...
plot_0.6 <- coin_plot(times=1, coins=1000, prob_of_heads=0.6)
plot_0.6
```
...
- What will this look like if the probability of heads is $0.5$? 
...
plot_0.5 <- coin_plot(times=1, coins=1000, prob_of_heads=0.9)
plot_0.2 <- coin_plot(times=1, coins=1000, prob_of_heads=0.2)

(plot_1.0 + plot_0.9 ) / (plot_0.5 + plot_0.2) + 
